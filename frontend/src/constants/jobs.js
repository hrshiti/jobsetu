...
export const JOBS_LIST = [
  {
    ...
    requirements: [
      ...
      'Excellent understanding of web performance, caching, and state management.',
      'Ability to write clean, reusable, semantic, and accessible code (WCAG).'
    ]
  },
  {
    id: 'eng-02',
    ...
    requirements: [
      ...
      'Experience with SQL/NoSQL databases like PostgreSQL and MongoDB.',
      'Familiarity with RESTful API design and integration.',
      'Experience with modern devops tools (Docker, AWS, Git).'
    ]
  },
  {
    id: 'des-01',
    ...
    requirements: [
      ...
      'Familiarity with Figma, component systems, and design tokens.',
      'Basic understanding of frontend implementation (HTML/CSS/Tailwind).',
      'Passion for detail-oriented, premium, and clean UI aesthetics.'
    ]
  },
  {
    id: 'pm-01',
    ...
    requirements: [
      ...
      'Analytical mindset with proficiency in SQL, Amplitude, or similar tools.',
  ...
  },
  {
    ...
    requirements: [
      ...
      'Experience with Google Ads, Meta Ads, SEO, and content marketing.',
      'Strong copy-writing skills and visual sense.',
  ...
  },
  {
    ...
    requirements: [
      ...
      'Empathetic approach and strong problem-solving skills.',
      'Familiarity with helpdesk systems like Zendesk or Intercom.',
