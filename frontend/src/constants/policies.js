  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'Personal data, or personal information, means any information about an individual from which that person can be identified. We may collect, use, store and transfer different kinds of personal data about you which we have grouped together as follows: Identity Data (first name, last name, date of birth, gender), Contact Data (email address, telephone numbers, WhatsApp numbers), Technical Data (IP address, browser type and version, time zone setting and location), and Professional Data (qualification, university, passing year, resume, certificates, current employer, expected CTC, skills, portfolio links).'
      },
      {
        heading: '3. How We Use Your Personal Data',
        content: 'We will only use your personal data when the law allows us to. Most commonly, we will use your personal data to process and evaluate your job application, to contact you regarding openings, and to manage our relationship with you. We do not sell or trade your personal data to third parties.'
      },
      {
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'You warrant that all information submitted through the job application portal is true, accurate, current, and complete. Submission of falsified information, documents, or resumes will result in immediate disqualification and termination of your application.'
      },
      {
  ...
  cookie: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'We use cookies to understand how you interact with our website, to remember your preferences (like your dark mode setting), and to compile aggregate data about site traffic and site interaction so that we can offer better site experiences and tools in the future.'
      },
      {
    ...
    sections: [
      {
        ...
        content: 'The information contained in this website is for general information purposes only. While we endeavour to keep the information up to date and correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability or availability with respect to the website or the information, products, services, or related graphics contained on the website.'
      },
      {
